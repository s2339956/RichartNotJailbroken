...
static _Bool _logos_method$_ungrouped$JailbreakDetection$jailbroken(_LOGOS_SELF_TYPE_NORMAL JailbreakDetection* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    HBLogDebug(@"-[<JailbreakDetection: %p> jailbroken]", self);
